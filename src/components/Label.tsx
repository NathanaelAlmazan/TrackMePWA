...
import { useTheme, alpha, styled, Palette, PaletteColor } from '@mui/material/styles';

// ----------------------------------------------------------------------
export const StyledLabel = styled(Box)<{ ownerState: { color: string, variant: string } }>(({ theme, ownerState }) => {
    ...
    const colorStyle = {
      ...(ownerState.color !== 'default' && {
        ...
        // SOFT
        ...(softVariant && {
          color: (theme.palette[ownerState.color as keyof Palette] as PaletteColor)[lightMode ? 'dark' : 'light'],
...
const Label = forwardRef<HTMLDivElement, { children: ReactNode, color: string, variant?: string, startIcon?: ReactNode, endIcon?: ReactNode, sx?: object }>(
